...
ezra({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
  const { arg, repondre, verifGroupe, msgRepondu, superUser, auteurMessage, auteurMsgRepondu } = commandeOptions;
...
ezra({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: 'ban', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: 'bangroup', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: 'onlyadmin', categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: 'sudo', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: 'mention', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
  ...
  const mbdd = require('../luckydatabase/mention');
...
ezra({ nomCom: "save", aliases: ["send", "keep"], categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "save2", aliases: ["send2", "keep2"], categorie: "Mods" }, async (dest, zk, commandeOptions) => {
